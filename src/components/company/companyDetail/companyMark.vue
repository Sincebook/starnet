<template>
    <div class="com-mark">
         ...
         <div class="leavemessages">
            <span class="mg">留言</span>
            <span class="recent" >最近留言</span>
            <span class="sort">排序
            ...
            <div class="critism" id="criticism" style>
                <criticism v-for="item in 2" :key="item.id"></criticism>
...
export default {
    components: { Criticism, CriticismInput }
